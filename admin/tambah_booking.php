...
if(isset($_POST['simpan'])){
    ...
    $q = mysqli_query($conn,"INSERT INTO booking (nama_pelanggan,lapangan,tanggal,jam_mulai,durasi,total_harga) VALUES ('$nama','$lapangan','$tanggal','$jam','$durasi','$total')");
    if($q){ header("Location: booking.php"); exit; }
...
<div class="main">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-0" style="color:#e0ffe8">Tambah Booking</h4>
            <small style="color:#2a4030">Isi form untuk menambah booking baru</small>
        </div>
    ...
    <div class="card-form">
        <form method="POST">
            <div class="mb-3">
                ...
                <div class="input-wrap"><i class="ti ti-user"></i><input type="text" name="nama" class="form-control" placeholder="Nama pelanggan" required></div>
            </div>
            <div class="mb-3">
                <label class="form-label">Lapangan</label>
                <div class="input-wrap"><i class="ti ti-building-stadium"></i><input type="text" name="lapangan" class="form-control" placeholder="Nama lapangan" required></div>
            </div>
            ...
            <div class="row g-3 mb-4">
                <div class="col-6">
                    ...
                    <input type="number" name="durasi" class="form-control" style="padding-left:12px" placeholder="2" required>
                </div>
                <div class="col-6">
                    <label class="form-label">Total Harga</label>
                    <input type="number" name="total" class="form-control" style="padding-left:12px" placeholder="200000" required>
                </div>
            </div>
